...
const FeatureItem = ({title,icon,description}:FeatureItem) =>{
    return(
      <li className='flex w-full flex-1 flex-col items-start max-md:text-center max-md:items-center'>
        ...
        <p className='regular-16 mt-2 bg-white/80 text-gray-30 lg:mt-[20px] lg:bg-none'>{description}</p>
      </li>
    )
}
